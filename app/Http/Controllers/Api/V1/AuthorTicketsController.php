...
class AuthorTicketsController extends ApiController
{
    ...
    public function store(StoreTicketRequest $request)
    {
        ...
        try {
            ...
            return $this->error(["You're not authorized to create that resource."], 401);
        }
    }
    ...
    public function destroy($author_id, $ticket_id)
    {
        try {
            ...
            return $this->error(["You're not authorized to delete that resource."], 401);
        }
    }
    ...
    public function replace(ReplaceTicketRequest $request, $author_id, $ticket_id)
    {
        ...
        try {
            ...
            return $this->error(["You're not authorized to replace that resource."], 401);
        }
    }
    ...
    public function update(UpdateTicketRequest $request, $author_id, $ticket_id)
    {
        ...
        try {
            ...
            return $this->error(["You're not authorized to update that resource."], 401);
        }
    }
